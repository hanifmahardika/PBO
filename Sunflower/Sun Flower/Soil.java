...
public class Soil extends World
{
    ...
    private void prepare()
    {
        ...
        addObject(pot, 258, 287);
        pot.setLocation(298, 325);
        biji biji = new biji();
        ...
        tunas2.setLocation(299, 244);
        removeObject(tunas2);
        counter.setLocation(44, 91);
        Temperature temperature = new Temperature();
        addObject(temperature, 48, 151);
        temperature.setLocation(40, 139);
        temperature.setLocation(61, 150);
    }
