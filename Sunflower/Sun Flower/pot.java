...
public class pot extends Actor
{
    ...
    public pot(Temperature tempCounter)
    {
        temperature = tempCounter;
    }
    ...
    public void progress()
    {
        ...
        if(counter.getValue() >= 200)
        {
            ...
            ((Soil)getWorld()).setBackground("bukitMalam.jpg");
            getWorld().removeObjects(getWorld().getObjects(matahari.class));
            bulan newBulan;
            newBulan = new bulan();
            getWorld().addObject(newBulan, 297, 74);
            ...
            World world;
            world = getWorld();
            world.addObject(newTunas2, 299, 244);
        ...
        if(counter.getValue() >= 300)
        {
            ...
            World world;
            world = getWorld();
            world.addObject(newMature, 299, 244);

            // ganti background & bulan
            ((Soil)getWorld()).setBackground("bukit.jpg");
